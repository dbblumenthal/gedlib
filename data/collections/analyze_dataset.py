...
parser.add_argument("--topology",
                    help="compute topology avgerage number components and ratio of acyclic and planar graphs",
                    action="store_true")
...
print("nodes (min / max / mean / std / median): " + str(np.min(nums_nodes)) + " & " + str(
    np.max(nums_nodes)) + " & " + str(np.mean(nums_nodes)) + " & " + str(np.std(nums_nodes, ddof=1)) + " & " + str(
    np.median(nums_nodes)))
print("edges (min / max / mean / std / median): " + str(np.min(nums_edges)) + " & " + str(
    np.max(nums_edges)) + " & " + str(np.mean(nums_edges)) + " & " + str(np.std(nums_edges, ddof=1)) + " & " + str(
