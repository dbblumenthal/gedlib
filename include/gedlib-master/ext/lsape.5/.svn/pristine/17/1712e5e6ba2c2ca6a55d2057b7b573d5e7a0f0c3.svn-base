...
%  hungarianLSAP.cpp - Compute a solution to (balanced or unbalanced) LSAP instance with Hungarian algorithm
% 
...
%
%  Given a nxm cost matrix C with non-negative values (integer ou floatting values) it computes:
%
