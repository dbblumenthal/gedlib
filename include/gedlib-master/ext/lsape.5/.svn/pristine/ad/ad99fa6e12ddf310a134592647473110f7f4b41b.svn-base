...
void lsape_helper(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[], const mxClassID &mxC)
{
  ...
  //------------------------------------------------------------------
  size_t dimr[2] = { nrc[0]-1, 1 }, dimc[2] = { 1, nrc[1]-1 }, i = 0;
  ...
  lsapeSolver<DT>(C,nrows,ncols,rho,varrho,u,v,model_type,init_type);
  if (nlhs == 3)
  {
    DT mincost = 0;
...
{
  if (nrhs < 1 || nrhs > 3 || nlhs < 2 || nlhs > 4) mexErrMsgTxt("USAGE: [rho,varrho] = lsapeSolver(C,model_type,init_type)\nUSAGE: [rho,varrho,mincost] = lsapeSolver(C,model_type,init_type)\nUSAGE: [rho,varrho,u,v] = lsapeSolver(C,model_type,init_type)\n See help for more details\n");
