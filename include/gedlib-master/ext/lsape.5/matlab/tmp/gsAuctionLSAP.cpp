...
#include <cstdio>
#include <string>
#include <GaussSeidelAuctionLSAP.h>
#include <utils.hh>

//------------------------------------------------------------------
template <typename DT>
void gsAuctionLSAP_helper(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[], const mxClassID &mxC)
{
  ...
  GaussSeidelAuctionLSAP<DT,int> auctions(C, n);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] )
{
  ...
  switch(tclass)
  {
    case mxINT16_CLASS: gsAuctionLSAP_helper<short>(nlhs,plhs,nrhs,prhs,tclass); break;
    case mxINT32_CLASS: gsAuctionLSAP_helper<int>(nlhs,plhs,nrhs,prhs,tclass); break;
    case mxINT64_CLASS: gsAuctionLSAP_helper<int64_T>(nlhs,plhs,nrhs,prhs,tclass); break;
    case mxSINGLE_CLASS: gsAuctionLSAP_helper<float>(nlhs,plhs,nrhs,prhs,tclass); break;
    default: gsAuctionLSAP_helper<double>(nlhs,plhs,nrhs,prhs,tclass);
  }
}
