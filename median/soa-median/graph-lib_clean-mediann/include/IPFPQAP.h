...
public:
  ...
  virtual void getBetterMappingFromInit(int kReturned, int* numConv, Graph<NodeAttribute,EdgeAttribute> * g1,
                                         Graph<NodeAttribute,EdgeAttribute> * g2,
                                         int* G1_to_G2, double * X0 = NULL );
  ...
  virtual void IPFPalgorithm(int kReturned, int* numConv, Graph<NodeAttribute,EdgeAttribute> * g1,
                     Graph<NodeAttribute,EdgeAttribute> * g2);
                  ...
                  int * G1_to_G2, int* G2_to_G1,  bool fromInit )
{
  ...
  getBetterMappingFromInit(kReturned, numConv, g1, g2, G1_to_G2, this->Xk);
...
template<class NodeAttribute, class EdgeAttribute>
void IPFPQAP<NodeAttribute, EdgeAttribute>::
getBetterMappingFromInit( int kReturned, int* PnumConv, Graph<NodeAttribute,EdgeAttribute> * g1,
                           Graph<NodeAttribute,EdgeAttribute> * g2,
                           int* G1_to_G2, double * X0)
{
  this->_n = g1->Size();
  ...
  this->IPFPalgorithm(kReturned,PnumConv,g1,g2);
