...
void
AllPerfectMatchings<IT>::strongConnect( const cDigraph<IT>& gm, int v ){
...
AllPerfectMatchings<IT>::~AllPerfectMatchings(){
  /*  //XXX /!\ Let the user manager their memory -> see deleteMatching()
  // free the allocated memory of perfectMatchings
  for(typename std::list<IT*>::const_iterator it=perfectMatchings.begin(); it != perfectMatchings.end(); it++)
    delete[] *it;
  //*/
}
