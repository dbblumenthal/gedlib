...
/*!
 * @file tests/sspr2018/src/learn_subgraph_depths.cpp
 * @brief Learn the parameters of the method ged::Subgraph for different datasets.
...
void learn_depth_for_dataset(const std::string & dataset) {
	...
	env.set_method(ged::Options::GEDMethod::SUBGRAPH, std::string("--threads 11 --save ../output/") + dataset + "_subgraph.ini");
	env.init_method();
}
